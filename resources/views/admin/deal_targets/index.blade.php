                        ...
                        <tr id="{{$target->id}}">
                            ...
                            <td>
                                <form action="javascript:void(0)" method="post">
                                    @csrf
                                    <button data-id="{{ $target->id }}" data-name="{{$target->target_deal}}" data-toggle="tooltip" data-placement="top" title="" data-original-title="حذف الهدف"  class="btn  btn-danger del">
                                        <i class="la la-trash-o"></i>
                                    </button>
                                    <a href="{{route('admin.deal-targets.edit',[$target->id])}}" class="btn btn-info" data-toggle="tooltip" data-placement="top" title="" data-original-title="تعديل الهدف" ><i class="la la-edit"></i></a>
                                </form>
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="5" align="center">لاتوجد اي اهداف للانواع</td>
                        </tr>
                    @endforelse
                </tbody>
                <tfoot>
